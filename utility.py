...
class Utility:
    ...
    def tree_printer(self, classifier, dataframe_x, list_y, tree_path='default.png'):
        """
        ...
        """
        most_important_nodes = self.most_important_nodes_generator(list_y, classifier, dataframe_x)
        ...
        try:
            ...
            for edge in edges:
                ...
                for i in range(2):
                    ...
                    print(dest.get_pos)
                    print('get_name')
                    print(str(dest.get_name))
                    print('get_id')
                    print(str(dest.get_id))
                    print('get_fillcolor')
                    print(dest.get_fillcolor)
                    """
    ...
    @staticmethod
    def most_important_nodes_generator(list_y, classifier, dataframe_x):
